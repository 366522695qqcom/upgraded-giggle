...
import { PolicyType } from "../../../core/game/Game";
...
export const PolicySystemUI: React.FC = () => {
  ...
  const [researchedTechs, setResearchedTechs] = useState<Set<TechType>>(
    new Set(),
  );
    ...
    <div className="h-full w-full flex flex-col bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
      <div className="border-b border-gray-200 bg-gray-50">
        ...
        >
          ...
          <TabsContent
            value="tech-tree"
            className="p-0 m-0 h-[calc(100%-64px)]"
          >
            <TechTree
              playerId={player.id()}
