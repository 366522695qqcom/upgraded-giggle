...
import { Player, Tech, TechType } from "../../../core/game/Game";
          ...
          <div className="research-progress">
            ...
            <div className="progress-bar">
              <div
                ...
                style={{
                  width: `${(currentResearch.progress / currentResearch.tech.researchTime) * 100}%`,
                }}
              />
            </div>
      ...
      {hoveredTech && (
        <div className="tech-tooltip">
          ...
          <div className="tech-details">
            ...
            {Techs[hoveredTech].prerequisites &&
              Techs[hoveredTech].prerequisites.length > 0 && (
              ...
              <ul>
                ...
                {Techs[hoveredTech].effects.unitCostReduction && (
                  <li>
                    单位成本 -
                    {(
                      Techs[hoveredTech].effects.unitCostReduction! * 100
                    ).toFixed(0)}
                    %
                  </li>
                )}
                {Techs[hoveredTech].effects.attackBonus && (
                  <li>
                    攻击加成 +
                    {(Techs[hoveredTech].effects.attackBonus! * 100).toFixed(0)}
                    %
                  </li>
                )}
                {Techs[hoveredTech].effects.defenseBonus && (
                  <li>
                    防御加成 +
                    {(Techs[hoveredTech].effects.defenseBonus! * 100).toFixed(
                      0,
                    )}
                    %
                  </li>
                ...
                {Techs[hoveredTech].effects.unlockedUnits &&
                  Techs[hoveredTech].effects.unlockedUnits.length > 0 && (
                    <li>
                      解锁单位:{" "}
                      {Techs[hoveredTech].effects.unlockedUnits.join(", ")}
                    </li>
                  )}
              </ul>
            </div>
